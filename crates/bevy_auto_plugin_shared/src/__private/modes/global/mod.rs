...
pub mod __internal {
    ...
    pub static GLOBAL_AUTO_PLUGIN_REGISTRY: LazyLock<GlobalAutoPluginRegistry> =
        LazyLock::new(|| {
    ...
    pub fn _plugin_entry_block(
        ...
        quote! {
            ::bevy_auto_plugin::__internal::shared::_plugin_entry!(
                #static_ident,
                ::bevy_auto_plugin::__internal::shared::__private::modes::global::__internal::GlobalAutoPluginRegistryEntryFactory::new(
                    || <#plugin as ::bevy_auto_plugin::__internal::shared::__private::modes::global::__internal::AutoPluginTypeId>::type_id(),
                    #expr
                )
            );
        }
    ...
    macro_rules! _plugin_entry {
        ($static_ident:ident, $entry:expr) => {
            #[::bevy_auto_plugin::__internal::shared::__private::modes::global::__internal::linkme::distributed_slice(::bevy_auto_plugin::__internal::shared::__private::modes::global::__internal::GLOBAL_AUTO_PLUGINS)]
            #[linkme(crate = ::bevy_auto_plugin::__internal::shared::__private::modes::global::__internal::linkme)]
            #[allow(non_upper_case_globals)]
            static $static_ident:
                ::bevy_auto_plugin::__internal::shared::__private::modes::global::__internal::GlobalAutoPluginRegistryEntryFactory =
                $entry;
        };
    }
    ...
    macro_rules! _plugin_entry {
        ($static_ident:ident, $entry:expr) => {
            ::bevy_auto_plugin::__internal::shared::__private::modes::global::__internal::inventory::submit!(
                $entry
            );
        };
    }
